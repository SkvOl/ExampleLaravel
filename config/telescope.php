    ...
    */
    ...
    'watchers' => [
        ...
        Watchers\ClientRequestWatcher::class => [
            ...
            'slow' => env('TELESCOPE_SLOW_OUTGOING_REQUESTS_THRESHOLD'),
        ],
        ...
        Watchers\JobWatcher::class => [
            ...
            'slow' => env('TELESCOPE_SLOW_JOBS_THRESHOLD'),
        ],
        ...
        Watchers\QueryWatcher::class => [
            ...
            'ignore_packages' => true,
            'ignore_paths' => [],
            'slow' => env('TELESCOPE_SLOW_QUERIES_THRESHOLD'),
        ],
        ...
        Watchers\RequestWatcher::class => [
            ...
            'ignore_http_methods' => [],
            'ignore_status_codes' => [],
            'slow' => env('TELESCOPE_SLOW_REQUESTS_THRESHOLD'),
        ],
