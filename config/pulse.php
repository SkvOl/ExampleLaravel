    ...
    */
    ...
    'recorders' => [
        ...
        Recorders\SlowJobs::class => [
            ...
            'threshold' => env('PULSE_SLOW_JOBS_THRESHOLD', env('PULSE_SLOW_JOBS_THRESHOLD')),
            'ignore' => [
                // '/^Package\\\\Jobs\\\\/',
            ],
        ],
        ...
        Recorders\SlowOutgoingRequests::class => [
            ...
            'threshold' => env('PULSE_SLOW_OUTGOING_REQUESTS_THRESHOLD', env('PULSE_SLOW_OUTGOING_REQUESTS_THRESHOLD')),
            'ignore' => [
        ...
        Recorders\SlowQueries::class => [
            ...
            'threshold' => env('PULSE_SLOW_QUERIES_THRESHOLD', env('PULSE_SLOW_QUERIES_THRESHOLD')),
        ...
        Recorders\SlowRequests::class => [
            ...
            'threshold' => env('PULSE_SLOW_REQUESTS_THRESHOLD', env('PULSE_SLOW_REQUESTS_THRESHOLD')),
            'ignore' => [
